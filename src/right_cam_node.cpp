 ...
 * @Last Modified time: 2022-11-27 12:50:54
 */
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "right_cam_node");
  ros::NodeHandle nh;
  ros::Rate r(30);
  ...
  image_transport::Publisher publisher = it.advertise("/right_cam", 1000);
