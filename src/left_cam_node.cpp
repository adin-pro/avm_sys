 ...
 * @Last Modified time: 2022-11-27 12:51:10
 */
...
int main(int argc, char **argv) {
  ros::init(argc, argv, "left_cam_node");
  ros::NodeHandle nh;
  ros::Rate r(30);
  ...
  image_transport::Publisher publisher = it.advertise("/left_cam", 1000);
